 ...
 * @author Momo
 */
public class ViewHistoryOfAPlayerController implements Initializable {

    @FXML
    private TextArea ViweTextAreaFxid;
    ...
    @FXML
    private void ViweHistryButton(ActionEvent event) {
        
         ViweTextAreaFxid.clear();
        ...
        try (FileInputStream fis = new FileInputStream(file);
            ...
            ViweTextAreaFxid.appendText(outputText.toString());
