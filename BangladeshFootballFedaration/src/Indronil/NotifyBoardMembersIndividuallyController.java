 ...
 * @author Indro
 */
public class NotifyBoardMembersIndividuallyController implements Initializable {

    @FXML
    private PasswordField player41;
    @FXML
    ...
    @FXML
    private TextField player511;
    @FXML
    private CheckBox player11;
    @FXML
