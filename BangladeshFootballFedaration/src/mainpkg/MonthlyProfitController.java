...
public class MonthlyProfitController implements Initializable {
    ...
    @FXML
    private TableView<Finance> profitview;
    @FXML
    private TableColumn<Finance,String> profit;
    ...
    public void initialize(URL url, ResourceBundle rb) {
         profit.setCellValueFactory(new PropertyValueFactory<Finance,String>("monthlyprofit"));
    }    
