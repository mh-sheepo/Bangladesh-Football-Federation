...
public class PayTaxController implements Initializable {
    ...
    @FXML
    private TableView<Finance> taxrecordsTable;
    @FXML
    private TableColumn<Finance,String> taxrecords;
    ...
    public void initialize(URL url, ResourceBundle rb) {
     taxrecords.setCellValueFactory(new PropertyValueFactory<Finance,String>("taxes"));
    }    
    ...
    try {
        ...
        while ((s = (Finance) ois.readObject()) != null) {
            taxrecordsTable.getItems().add(s);
        }
